  ...
  return (
    <div>
          ...
          <div key={s.n} className="flex items-center flex-1">
            <div className="flex items-center gap-2">
              ...
              <span className={`text-xs font-medium hidden sm:block ${
                step === s.n ? "text-teal-700" : "text-gray-400"
              }`}>{s.label}</span>
            </div>
            {i < STEPS.length - 1 && (
            ...
            <div>
              ...
              {form.dateOfBirth && (
                <p className="text-xs text-gray-400 mt-1">
                  Age: {Math.floor((Date.now() - new Date(form.dateOfBirth)) / 31557600000)} years
                </p>
              )}
            </div>
            <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select value={form.emergencyContactRelation}
                  ...
                  <option value="">Select...</option>
                  {["Spouse","Parent","Child","Sibling","Grandparent","Friend","Guardian","Other"].map(r => (
      ...
      {step === 3 && (
        <div className="space-y-4">
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-4">
            <p className="text-red-700 text-sm font-semibold mb-3 flex items-center gap-2">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {["Diabetes Mellitus","Hypertension","Asthma","Heart Disease","HIV/AIDS",
                ...
                <button key={c} type="button"
                  onClick={() => set("chronicConditions",
                    form.chronicConditions ? `${form.chronicConditions}, ${c}` : c)}
      ...
      {step === 4 && (
        <div className="space-y-4">
          <h3 className="font-semibold text-gray-800 flex items-center gap-2">
            <FileText className="w-4 h-4 text-teal-600" /> Insurance & Initial Visit
          </h3>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-400 flex-wrap">
                      ...
                      {age(patient.dateOfBirth) && (
                        <><span>•</span><span>{age(patient.dateOfBirth)} yrs</span></>
                      )}
                      <span>•</span>
                      <span>{patient.phone}</span>
                      {patient.bloodGroup && (
                        <><span>•</span>
                        <span className="font-medium">{patient.bloodGroup?.replace(/_/g," ")}</span></>
                      )}
                    </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-gray-800">
                New Visit — {selected.firstName} {selected.lastName}
              </h3>
              <button onClick={() => setShowNewVisit(false)} className="text-gray-400 hover:text-gray-600">
                <X className="w-5 h-5" />
              </button>
            </div>
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea value={visitForm.chiefComplaint}
                  onChange={e => setVisitForm(p => ({...p, chiefComplaint: e.target.value}))}
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <button onClick={fetchQueue}
          className="text-gray-400 hover:text-teal-600 p-2 rounded-lg hover:bg-teal-50">
      ...
      {loading ? (
        ...
        visits.map((visit, idx) => {
          ...
          return (
            <div key={visit.id}
              className="border border-gray-200 rounded-xl p-3 flex items-center gap-4 hover:border-teal-200 transition-colors">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <span className="text-xs text-gray-400 flex items-center gap-1">
                  <Clock className="w-3 h-3" />{getWait(visit.createdAt)}
                </span>
